...
\OCP\Util::connectHook('OC_Filesystem', 'post_create', 'OCA\TestApp\hooks\Hooks', 'postCreate');
\OCP\Util::connectHook('OC_User', 'post_createUser', 'OCA\TestApp\hooks\Hooks', 'postCreateUser');